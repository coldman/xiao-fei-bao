...
$(function(){
	...
	columns: [
	    ...
	    {display:'区域', name:'region', align:'left', width:'150', frozen: true},
	    {display:'结算月份', name:'month', align:'left', width:'100' },
	    {display:'营业额', name:'amount', align:'right', width:'100' },
	    {display:'佣金', name:'settled_amount', align:'left', width:'100' }
	], 
	dataAction:'server', 
	pageSize:20, 
